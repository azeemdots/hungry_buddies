                ...
                <div class="header-top-bar" style="background-color:#fff;">
                    <div class="container">
                        ...
                        <div class="header-register">
                            <a class="btn btn-link" id="register" style="color:#000;">Register</a>
            ...
            <div class="container" style="margin-top: 30px;">
                <div class="col-lg-6 col-lg-offset-1">
                    ...
                    <?php if (!empty($message)) { ?>
                        <div id="infoMessage" class="alert alert-message alert-warning" ><?php echo $message; ?><button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button></div>
                    <?php } ?>
                ...
                <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-xs-6 col-sm-12 col-md-6">
                                        <ul class="footer-links">
                                            <li><a href="<?= base_url('index.php/main/job_listing'); ?>">Jobs</a></li>
                                            <li><a href="<?= base_url('index.php/main/faqs'); ?>">FAQ's</a></li>
                                            <li><a href="<?= base_url('index.php/main/terms'); ?>">Terms & Condition</a></li>
                                            <li><a href="<?= base_url('index.php/main/advertise'); ?>">Advertise Here</a></li>
                                        </ul>
                                    </div>

                                    <div class="col-xs-6 col-sm-12 col-md-6">
                                        <ul class="footer-links">
                                            <li><a href="<?= base_url(); ?>index.php/main/about_us">About Us</a></li>
                                            <li><a href="<?= base_url(); ?>index.php/main/contact_us">Contact Us</a></li>
                                            <li><a href="<?= base_url(); ?>index.php/main/privacy_policy">Privacy Policy</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-sm-3 col-md-2">
                        <div class="widget">
                            ...
                            <div class="widget-content">
                                <ul class="footer-links">
                                    <li><a href="<?= base_url(); ?>/index.php/main/jobs">Web Developer</a></li>
                                    <li><a href="<?= base_url(); ?>/index.php/main/jobs">Web Designer</a></li>
                                    <li><a href="<?= base_url(); ?>/index.php/main/jobs">UX Engineer</a></li>
                                    <li><a href="<?= base_url(); ?>/index.php/main/jobs">Account Manager</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
