                                ...
                                <table border="0" cellpadding="0" cellspacing="0" width="600" id="templateHeader">
                                    <tr>
                                        <td class="headerContent">
                                            ...
                                            <img src="<?= base_url('images/logo.png') ?>" style="max-width:600px; margin-top:10px;" id="headerImage campaign-icon" />
                                            <!-- // End Module: Standard Header Image \\ -->
                                            <h6 style="margin-top:10px;text-align: center;">We Would Be Honored to Serve You!</h6>
                                        </td>
                                    </tr>
                                </table>
                                <!-- // End Template Header \\ -->
                                    ...
                                    <tr>
                                        <td valign="top">
                                            <div mc:edit="std_footer">
                                                <em>Copyright &copy; |2015| |Kaam Kaaj|, All rights reserved.</em>

                                                <br />
                                                <strong>Our mailing address is:</strong>
                                                <br />
                                                <strong>info@kaamkaaj.com</strong>
                                            </div>
                                        </td>
                                    </tr>
