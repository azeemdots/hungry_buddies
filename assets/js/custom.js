...
function autoComplete(){
    if( !$("script[src='http://localhost/bitbucket/hungry_buddies/assets/js/leaflet.js']").length ){
...
function drawOwlCarousel(_rtl){
    $.getScript( "http://localhost/bitbucket/hungry_buddies/assets/js/owl.carousel.min.js", function( data, textStatus, jqxhr ) {
...
function initializeOwl(_rtl){
    $.getScript( "http://localhost/hungry_buddies/assets/js/owl.carousel.min.js", function( data, textStatus, jqxhr ) {
        ...
        if( category == 'real_estate' ){
            if( json.data[a].item_specific ){
                if( json.data[a].item_specific.bedrooms ){
                    itemSpecific += '<span title="Bedrooms"><img src="http://localhost/bitbucket/hungry_buddies/assets/img/bedrooms.png">' + json.data[a].item_specific.bedrooms + '</span>';
                }
                if( json.data[a].item_specific.bathrooms ){
                    itemSpecific += '<span title="Bathrooms"><img src="http://localhost/bitbucket/hungry_buddies/assets/img/bathrooms.png">' + json.data[a].item_specific.bathrooms + '</span>';
                }
                if( json.data[a].item_specific.area ){
                    itemSpecific += '<span title="Area"><img src="http://localhost/bitbucket/hungry_buddies/assets/img/area.png">' + json.data[a].item_specific.area + '<sup>2</sup></span>';
                }
                if( json.data[a].item_specific.garages ){
                    itemSpecific += '<span title="Garages"><img src="http://localhost/bitbucket/hungry_buddies/assets/img/garages.png">' + json.data[a].item_specific.garages + '</span>';
                }
                return itemSpecific;
            }
        }
...
function quickView(id){
    $.ajax({
        type: 'POST',
        url: 'http://localhost/bitbucket/hungry_buddies/assets/external/_modal.html',
        data: id,
